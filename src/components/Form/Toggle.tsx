...
>(({ className, ...props }, ref) => (
  <Switch.Root
    className={`relative h-6 w-11 cursor-pointer rounded-full bg-primary-dark transition-colors focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-discord-blue ${className ?? ''}
    `}
    {...props}
    ref={ref}
  >
