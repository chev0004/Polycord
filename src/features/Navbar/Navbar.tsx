    ...
    <nav className="flex h-16 w-full items-center justify-between gap-4 bg-background-darker px-4 font-zen sm:px-10">
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex select-none items-center gap-2.5 font-black font-figtree text-2xl text-white tracking-[-0.01em] no-underline focus:outline-none sm:text-[28px]"
        >
          <Image
