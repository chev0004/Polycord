...
export const createSampleProfiles = (
...
): DiscoveryProfile[] => [
  {
    ...
    tags: ['Anime', 'K-Pop', 'Gaming', 'Coding', 'Creative Writing'],
    country: 'Japan',
    timezone: 'Asia/Tokyo',
  ...
  },
  {
    ...
    tags: ['Languages', 'K-Dramas', 'Food', 'Travel', 'Photography', 'History'],
    country: 'Singapore',
    timezone: 'Asia/Singapore',
    availability: { days: 'weekends', from: '10:00', to: '15:00' },
    allowAnonymousCopy: true,
  ...
  },
  {
    ...
    tags: ['Gaming', 'Travel', 'Photography'],
    country: 'Egypt',
  ...
  },
  {
    ...
    tags: ['Anime', 'Music', 'Studying', 'Lo-fi', 'Dialect'],
    country: 'Japan',
    timezone: 'Asia/Tokyo',
    allowAnonymousCopy: false,
    lastBumpRelative: t('bumpTwoDays'),
