...
export const createSampleProfiles = (
...
): DiscoveryProfile[] => [
  {
    ...
    lookingFor: ['casual_chat', 'grammar_help', 'gaming'],
    country: 'Japan',
    timezone: 'Asia/Tokyo',
  ...
  },
  {
    ...
    lookingFor: ['study_buddy', 'grammar_help'],
  ...
  },
  {
    ...
    lookingFor: ['exam_prep', 'voice_practice'],
    country: 'Japan',
    timezone: 'Asia/Tokyo',
    allowAnonymousCopy: false,
    lastBumpRelative: t('bumpTwoDays'),
